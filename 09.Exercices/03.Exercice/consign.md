L'objectif est de créer une interface pour représenter des informations sur des étudiants et d'utiliser cette interface pour créer des objets étudiant avec différentes propriétés.
